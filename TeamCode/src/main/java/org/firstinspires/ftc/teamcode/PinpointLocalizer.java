...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYInches = 0.0; // y position of the parallel encoder (in tick units)
        public double perpXInches = 0.0; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public PinpointLocalizer(HardwareMap hardwareMap, double ticksPerMm, Pose2d initialPose) {
        ...
        driver.setOffsets(PARAMS.parYInches, PARAMS.perpXInches, DistanceUnit.INCH);
