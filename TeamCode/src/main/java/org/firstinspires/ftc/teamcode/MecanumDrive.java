...
public final class MecanumDrive {
    ...
    public static class Params {
        ...
        public double inPerTick = (1/ENCODER_TICKS_PER_MM) / 25.4;
        public double lateralInPerTick = inPerTick * 0.75;
        public double trackWidthTicks = 7487.210947899027;
        ...
        public double maxAngVel = 5*Math.PI; // shared with path
        public double maxAngAccel = 7*Math.PI;
...
//    }
    ...
    public TrajectoryActionBuilder actionBuilder(Pose2d beginPose) {
        return actionBuilder(beginPose, new PoseMap() {
            @NonNull
            @Override
