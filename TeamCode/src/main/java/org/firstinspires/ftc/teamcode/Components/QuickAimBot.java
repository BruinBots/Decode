    ...
    public void readAprilTag() {
        ...
        for (AprilTagDetection detection : currentDetections) {
            if (detection.metadata != null && (detection.id == 20 || detection.id == 24)) {
                ...
                MainBot.shared.telemetry.addData("Heading", h);
                ...
                MainBot.shared.telemetry.addData("Tag Field Pose", tagFieldPos.x+","+tagFieldOffset.y);
